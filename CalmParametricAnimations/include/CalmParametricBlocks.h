...
@interface CalmParametricBlocks : NSObject
 ...
 */
typedef id (^ParametricValueBlock)(double progress, id fromValue, id toValue);
...
extern const double (^kParametricAnimationBezierEvaluator)(double time, CGPoint ct1, CGPoint ct2);
...
extern const ParametricTimeBlock kParametricTimeBlockEaseOutDramatic;

extern const ParametricTimeBlock kParametricTimeBlockBackIn;
extern const ParametricTimeBlock kParametricTimeBlockBackOut;
extern const ParametricTimeBlock kParametricTimeBlockEaseInBackOut;
...
extern const ParametricValueBlock kParametricValueBlockTransform3D;
